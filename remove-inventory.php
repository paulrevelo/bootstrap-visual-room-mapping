...
<html>
  <head>
    ...
    <title>SGS Inventory System » Remove Inventory</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Remove Inventory</a></li>
          </ol>
        </section>
            ...
            <div class="col-sm-12">
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <div class="box-tools">
                    <form class="form-inline" action="remove.php" method="post">
                        <div class="form-group">
                          <input type="text" class="form-control" name="property_number" placeholder="Enter property number" required>
                        </div>                              
                        <button type="submit" class="btn btn-danger btn-flat">Remove</button>
                    </form>
                  </div>
                </div>
                <div class="box-body">
