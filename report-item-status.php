...
<html>
  <head>
    ...
    <title>SGS Inventory System » Table Reports » Item Status</title>
  ...
  <body class="skin-blue sidebar-mini sidebar-collapse">
    <div class="wrapper">
      ...
      <?php 
        $current_page = "report-item-status";
        include("header.php"); 
      ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Table Reports
            <small>By Item Status</small>
          </h1>

          <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="reports.php"><i class="fa fa-table"></i> Table Reports</a></li>
            <li class="active"><i class="fa fa-desktop"></i> By Item Status</li>
          </ol>
        </section>
