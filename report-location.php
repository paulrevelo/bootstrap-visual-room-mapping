...
<html>
  <head>
    ...
    <title>SGS Inventory System » Table Reports » Room Assignment</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Table Reports
            <small>By Room Assignment</small>
          </h1>

          <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="reports.php"><i class="fa fa-table"></i> Table Reports</a></li>
            <li class="active"><i class="fa fa-building"></i> By Room Assignment</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Room Assignment</h3>
